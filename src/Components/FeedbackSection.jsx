...
//     {
//       id: 5,
//       text: "A PX me ajudou com meus reels do instagram, desde a elaboração do roteiro até a gravação e edição. Apesar de não ter muito costume em ser gravada, ela fez com que eu me sentisse a vontade a todo momento, entregou rápido e com muita qualidade! Foi uma experiência muito legal e divertida, e uma parceria pro resto da vida",
//       author: "Nathalia",
//       instagram: "@nath_dev_",
...
//     }, {
//       id: 7,
//       text: "Queria te agradecer a PX pelo trabalho incrível que vocês vem fazendo nas minhas redes sociais. Tenho percebido o cuidado, a criatividade e a consistência nas postagens. Tá tudo com uma cara super profissional e alinhado com o que eu acredito.Seu trabalho tá fazendo a diferença e eu tô muito satisfeito com os resultados. Obrigado por estar somando comigo nessa jornada.Vamos com tudo!",
//       author: "Seu Gerente toyota",
//       instagram: "@seugerentetoyota",
//       image: toyota,
//     }, {
//       id: 8,
//       text: "Fechei parceria com a Publix para cuidar do tráfego pago e o resultado já está aparecendo!Desde que eles começaram a gerenciar os meus anúncios, o número de pessoas interessadas nos nossos carros só cresceu. Mais alcance, mais mensagens e mais vendas! obrigado a Publix por deixar minhas redes sociais com um padrão altíssimo de qualidade profissional.",
//       author: "Adriano Santos",
//       instagram: "@adrianosantos.toyota",
//       image: adriano,
//     }
//   ]
...
const FeedbackSection = () => {
  ...
  // Dividir os feedbacks entre iniciais e expandidos
  // Mantendo 4 iniciais para ter 2 pares completos em tablet
  const initialFeedbacks = feedbacks.slice(0, 4)
  const expandedFeedbacks = feedbacks.slice(4)
...
// Componente de Card de Feedback separado para melhor organização
const FeedbackCard = ({ feedback }) => {
  return (
    ...
    >
      ...
      {/* Texto do feedback - sem scroll, com altura fixa e line-clamp */}
      <div className="mb-4 flex-grow">
        <p className="text-white text-sm leading-relaxed line-clamp-6">{feedback.text}</p>
      </div>

      {/* Autor do feedback */}
      <div className="flex items-center mt-auto pt-3 border-t border-white/10">
        <div className="relative flex-shrink-0 w-10 h-10 rounded-full overflow-hidden border-2 border-white/30 mr-3">
          <img
            src={feedback.image || "/placeholder.svg"}
            alt={feedback.author}
            ...
            onError={(e) => {
              ...
              e.target.src =
                "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-4Mfhy7L0NLkUKYPW8FqRBPR98iLrGK.png"
            }}
          />
        </div>
        <div className="min-w-0 flex-1">
          <h4 className="text-white font-bold text-sm truncate">{feedback.author}</h4>
          <p className="text-white/70 text-xs truncate">{feedback.instagram}</p>
        </div>
      </div>
    </div>
  )
